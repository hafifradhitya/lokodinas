...
<div class="card">
    ...
    <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <a href="{{ url('administrator/modul-video/Action/tambahplaylistvideo') }}" class="btn btn-primary btn-sm">Tambahkan Data</a>
    </div>
        ...
        <table class="table table-bordered" id="datatable-basic">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ url('administrator/modul-video/Action/editplaylistvideo/'.$playlist->id_playlist.'/edit') }}" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-edit"></span>
                          Edit
                        </a>
